...
public class Utils {
	...
	// return new Drink(dto.getId(), dto.getName(), dto.getIngredients(),
	// dto.getPrice());
	// }
	//
	// public static DrinkDTO DrinkToDrinkDto(Drink d) {
	// return new DrinkDTO(d.getId(), d.getName(), d.getIngredients(),
	// d.getPrice());
	// }
	//
	// public static Consumer ConsumerDtoToConsumer(ConsumerDTO dto) {
	// return new Consumer(dto.getConsumerId(), dto.getDate(), dto.getPlace(),
	// UserDtoToUser(dto.getUserId()));
	// }
	//
	...
	// return new UserDTO(u.getId(), u.getName(), u.getPassword(),
	// RoleToRoleDto(u.getRole()));
	// }
	//
	// public static ConsumerDTO ConsumerToConsumerDto(Consumer c) {
	// return new ConsumerDTO(c.getId(), c.getDate(), c.getPlace(),
	// UserToUserDto(c.getUserId()));
	// }
	//
	// public static Order OrderDtoToOrder(OrderDTO dto) {
	// return new Order(dto.getId(), ConsumerDtoToConsumer(dto.getConsumerId()),
	// DrinkDtoMapToDrinkMap(dto.getDrinks()), dto.getStatus(), dto.getBill());
	// }
	//
	// public static OrderDTO OrderToOrderDto(Order o) {
	// return new OrderDTO(o.getId(), ConsumerToConsumerDto(o.getConsumerId()),
	// DrinkMapToDrinkDtoMap(o.getDrinks()), o.getStatus(), o.getBill());
	// }
	//
	// public static Map<Drink, Integer>
	// DrinkDtoMapToDrinkMap(Map<DrinkDTO,Integer> dtoMap) {
	...
	// }
	//
	// public static Map<DrinkDTO, Integer>
	// DrinkMapToDrinkDtoMap(Map<Drink,Integer> map) {
	// Map<DrinkDTO, Integer> dtoMap = new HashMap<DrinkDTO,
	// Integer>(map.size());
