...
@NamedNativeQueries({
		...
		@NamedNativeQuery(name = "UserEntity.findUsersByRoleId", query = "SELECT * FROM APP.USERS " + "WHERE user_id = ( " + "SELECT userid_user_id " + "FROM APP.USER_ROLE_MAP "
				+ "WHERE roleid_role_id = ? " + ") " + "ORDER by user_id ASC", resultClass = UserEntity.class) })
