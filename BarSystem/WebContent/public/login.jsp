...
<body>
	<div class="container">
		...
		<section class="main">
			...
			
			<form class="form-5" action="<%= getServletContext().getContextPath() + "/public/register.jsp" %>" name="myform">
				<p>
					<input type="submit" name="action" value="register"> <!--  with onclick="myform.target='POPUPW'; POPUPW = window.open(
  							 'about:blank','POPUPW','width=600,height=400');" to open the reg form in a new window-->
				</p>
			</form>
		</section>
