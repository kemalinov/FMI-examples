...
<body>	
	<div class="container">
		...
		<section class="main">
			...
			<form class="form-5" action="foward to controller servlet">
				<p>
			...
			if ( userm.isAdminUser((String)session.getAttribute("username"))) {
				
				%>
				<button id="monitor_btn" name="Monitor"></button>
